<template>
  <div class="flex justify-between tags-container" ref="containerDom" v-if="appStore.tag">
    <div class="menu-tags-wrapper" ref="scrollbarDom" :class="{ 'tag-pn': tagShowPrevNext }">
      ...
      <span class="pa-tag-prev" v-if="tagShowPrevNext">
        <IconLeft :size="20" class="tag-scroll-icon" @click="handleScroll(-500)" />
      </span>
      <span class="pa-tag-next" v-if="tagShowPrevNext">
        <IconRight :size="20" class="tag-scroll-icon" @click="handleScroll(500)" />
      </span>
    </div>
    <a-trigger class="pa-tags-more-dropdown" :popup-translate="[-65, -6]" :show-arrow="true" trigger="hover">
      <span class="pa-tags-more">
        <span class="pa-tags-more-icon">
          <i class="pa-box pa-box-t"></i>
          <i class="pa-box pa-box-b"></i>
        </span>
      </span>
      <template #content>
        <ul class="pa-tags-more-contextmenu">
...
<style scoped lang="less">
  ...
  .pa-tags-more:hover .pa-tags-more-icon .pa-box:before {
    background: rgb(var(--primary-6));
    transform: rotate(45deg);
  }

  .pa-tags-more:hover .pa-tags-more-icon .pa-box:after {
    background: rgb(var(--primary-6));
  }

  .pa-tags-more:hover .pa-tags-more-icon {
