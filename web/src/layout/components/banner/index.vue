...
<template>
  <a-layout class="layout flex flex-col h-full">
    <a-layout-header class="pa-ui-header flex justify-between h-50 layout-banner-header operation-area">
    ...
    <pa-tags class="hidden lg:flex pa-ui-tags" />
    <pa-worker-area />
  </a-layout>
</template>
...
<script setup>
  ...
  import PaOperation from '../pa-operation.vue'
  import PaWorkerArea from '../pa-workerArea.vue'
  import PaTags from '../pa-tags.vue'
