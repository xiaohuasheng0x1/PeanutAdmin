    ...
    <a-form :model="form" :auto-label-width="true">
      ...
      <a-form-item :label="$t('sys.animation')" :help="$t('sys.animationHelp')">
        <a-select v-model="form.animation" @change="handleAnimation">
          <a-option value="pa-fade">{{ $t('sys.animate.fade') }}</a-option>
          <a-option value="pa-slide-left">{{ $t('sys.animate.sliderLeft') }}</a-option>
          <a-option value="pa-slide-right">{{ $t('sys.animate.sliderRight') }}</a-option>
          <a-option value="pa-slide-down">{{ $t('sys.animate.sliderDown') }}</a-option>
          <a-option value="pa-slide-up">{{ $t('sys.animate.sliderUp') }}</a-option>
        </a-select>
      </a-form-item>
