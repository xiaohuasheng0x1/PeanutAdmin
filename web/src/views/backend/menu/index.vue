...
<script setup>
  ...
  const crud = reactive({
    ...
    operationWidth: 200,
    add: { show: true, api: menu.save, auth: ['menu:save'] },
    edit: { show: true, api: menu.update, auth: ['menu:update'] },
    delete: {
      show: true,
      api: menu.deletes, auth: ['menu:delete'],
      realApi: menu.realDeletes, realAuth: ['menu:realDeletes']
    },
    recovery: { show: true, api: menu.recoverys, auth: ['menu:recovery']},
  ...
  const columns = reactive([
    { title: 'ID', dataIndex: 'id', addDisplay: false, editDisplay: false, width: 50, hide: true },
    {
      ...
      dict: { url: 'backend/menu/tree', params: { onlyMenu: true } }, addDefaultValue: 0,
