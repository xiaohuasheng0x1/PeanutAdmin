  ...
  <div class="block">
    <div class="user-header rounded-sm text-center">
      <div class="pt-3 mx-auto avatar-box">
        <pa-upload v-model="userInfo.avatar" rounded returnType="url" />
      </div>
      <div>
    ...
    <a-layout-content class="block lg:flex lg:justify-between">
      <div class="pa-content-block w-full lg:w-6/12 mt-3 p-4">
        <a-tabs type="rounded">
      ...
      <div class="pa-content-block w-full lg:w-6/12 mt-3 p-4 ml-0 lg:ml-3">
        <a-tabs type="rounded">
...
<script setup>
  ...
  import PaUpload from '@cps/pa-upload/index.vue'
