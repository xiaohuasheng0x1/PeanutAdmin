...
-->
<template>
  <div class="pa-content-block p-3 lg:h-full block lg:border-0 lg:flex justify-between">
    ...
    <a-modal v-model:visible="receiveListVisible" width="1000px">
      ...
      <pa-crud :options="receiveCrud" :columns="receiveColumns" ref="receiveCrudRef" />
    </a-modal>
  </div>
...
<script setup>
  ...
  import queueMessage from '@/api/backend/queueMessage'
