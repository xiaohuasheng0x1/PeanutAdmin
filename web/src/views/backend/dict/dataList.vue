...
import { dict } from '@/api/backend/dict'
...
const crud = reactive({
  ...
  add: { show: true, api: dict.saveDictData, auth: ['dict:save'] },
  edit: { show: true, api: dict.updateDictData, auth: ['dict:update'] },
  delete: {
    show: true,
    api: dict.deletesDictData, auth: ['dict:delete'],
    realApi: dict.realDeletesDictData, realAuth: ['dict:realDeletes']
  },
  recovery: { show: true, api: dict.recoverysDictData, auth: ['dict:recovery'] },
