  ...
  >
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <a-select
        ...
        @dropdown-scroll="paEvent.handleCommonEvent(props.component, 'onDropdownScroll')"
        @dropdown-reach-bottom="paEvent.handleCommonEvent(props.component, 'onDropdownReachBottom')"
        @exceed-limit="paEvent.customeEvent(props.component, $event, 'onExceedLimit')"
...
const handleCascaderChangeEvent = async (value) => {
  ...
  if (component.onChange) {
    paEvent.handleChangeEvent(component, value)
  }
