  ...
  >
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <component
        ...
        @popup-visible-change="paEvent.customeEvent(props.component, $event, 'onvVisibleChange')"
        @select-shortcut="paEvent.customeEvent(props.component, $event, 'onSelectShortcut')"
...
const handlePickerChangeEvent = (value, date, dateString) => {
  paEvent.handleChangeEvent(props.component, { value, date, dateString })
}

const handlePickerSelectEvent = (value, date, dateString) => {
  paEvent.customeEvent(props.component, { value, date, dateString }, 'onSelect')
}

const handlePickerValueChangeEvent = (value, date, dateString) => {
  paEvent.customeEvent(props.component, { value, date, dateString }, 'onPickerValueChange')
}

const handlePickerOkEvent = (value, date, dateString) => {
  paEvent.customeEvent(props.component, { value, date, dateString }, 'onOk')
}
