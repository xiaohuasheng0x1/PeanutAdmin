...
import PaForm from "@/components/pa-form/index.vue"
import {Message} from "@arco-design/web-vue"
import PaInfo from "@/components/pa-info/index.vue"
...
const prop = defineProps({
  ...
  column: { type: Array, default: []}, // pa-form字段
  columns: {type: Array, default: []}, // pa-form字段 别名
  infoColumns: {type: Array, default: []},
  infoData: {type: Object, default:{}},
  default_visible: { type: Boolean, default: false }, // 默认隐藏
  options: { type: Object, default: {} }, // pa-form 属性
