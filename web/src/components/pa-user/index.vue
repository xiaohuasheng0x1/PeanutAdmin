...
<script setup>
  ...
  const columns = ref([
    ...
    { title: '邮箱', dataIndex: 'email', search: true },
    {
      ...
      hide: true,
      dict: { url: 'backend/common/getDeptTreeList' }
    },
    {
      title: '角色',
      dataIndex: 'role_id',
      ...
      formType: 'select',
      hide: true,
      dict: { url: 'backend/common/getRoleList', props: { label: 'name', value: 'code' } }
    },
    {
      title: '岗位',
      dataIndex: 'post_id',
      ...
      formType: 'select',
      hide: true,
      dict: { url: 'backend/common/getPostList', props: { label: 'name', value: 'code' } }
    },
  ])
</script>
