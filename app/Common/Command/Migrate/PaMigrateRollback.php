...
/**
 * Class PaMigrateRollback
 * @package System\Command\Migrate
 */
#[Command]
class PaMigrateRollback extends BaseCommand
{
    use Confirmable;

    protected ?string $name = 'pa:migrate-rollback';
    ...
    public function __construct(Migrator $migrator)
    {
        ...
        $this->setDescription('The run migrate rollback class of PeanutAdmin module');
    }
