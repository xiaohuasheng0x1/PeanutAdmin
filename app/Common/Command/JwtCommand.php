 ...
 */
#[Command]
class JwtCommand extends PaCommand
{
    /**
     * 生成JWT密钥命令
     * @var string|null
     */
    protected ?string $name = 'pa:jwt-gen';

    public function configure()
    {
        parent::configure();
        $this->setHelp('run "php bin/hyperf.php pa:gen-jwt" create the new jwt secret');
        $this->setDescription('PeanutAdmin system gen jwt command');
    }
