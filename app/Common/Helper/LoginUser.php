...
class LoginUser
{
    ...
    {
        return container()->get(UserService::class)->read($this->getId(), ['id'])->roles()->get($columns)->toArray();
    }
    ...
    {
        return container()->get(UserService::class)->read($this->getId(), ['id'])->posts()->get($columns)->toArray();
    }
    ...
    {
        return container()->get(UserService::class)->read($this->getId(), ['id'])->depts()->get($columns)->toArray();
    }
    ...
    {
        return in_array(
            container()->get(RoleService::class)->read(env('ADMIN_ROLE'), ['code'])->code,
            container()->get(UserService::class)->getInfo()['roles']
        );
    }
