 ...
 */
class SqlGenerator extends PaGenerator implements CodeGenerator
{
    /**
     * @var GenerateTables
     */
     ...
     * @throws \Exception
     */
    public function setGenInfo(GenerateTables $model, int $adminId): SqlGenerator
    {
        $this->model = $model;
    ...
    {
        return 'backend/' . $this->getShortBusinessName() . '/index';
    }
