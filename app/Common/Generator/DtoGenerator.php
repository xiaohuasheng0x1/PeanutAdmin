...
class DtoGenerator extends PaGenerator implements CodeGenerator
{
    /**
     * @var GenerateTables
     */
     ...
     */
    public function setGenInfo(GenerateTables $model): DtoGenerator
    {
        $this->model = $model;
    ...
    public function generator(): void
    {
        if ($this->model->generate_type === 1) {
            $path = BASE_PATH . "/runtime/generate/php/app/Backend/Dto/";
        } else {
            $path = BASE_PATH . "/app/Backend/Dto/";
        }
