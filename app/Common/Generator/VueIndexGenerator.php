 ...
 */
class VueIndexGenerator extends PaGenerator implements CodeGenerator
{
    /**
     * @var GenerateTables
     */
     ...
     */
    public function setGenInfo(GenerateTables $model): VueIndexGenerator
    {
        $this->model = $model;
    ...
    {
        $path = BASE_PATH . "/runtime/generate/vue/src/views/backend/{$this->getShortBusinessName()}/index.vue";
        $this->filesystem->makeDirectory(
            BASE_PATH . "/runtime/generate/vue/src/views/backend/{$this->getShortBusinessName()}",
            0755, true, true
        );
    ...
    protected function getOptions(): string
    {
        ...
        $requestRoute = 'backend/' . $this->getShortBusinessName();
        // 导入
