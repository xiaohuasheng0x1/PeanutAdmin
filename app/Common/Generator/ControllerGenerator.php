 ...
 */
class ControllerGenerator extends PaGenerator implements CodeGenerator
{
    /**
     * @var GenerateTables
     */
     ...
     */
    public function setGenInfo(GenerateTables $model): ControllerGenerator
    {
        $this->model = $model;
    ...
    public function generator(): void
    {
        if ($this->model->generate_type === 1) {
            $path = BASE_PATH . "/runtime/generate/php/app/Backend/Controller/";
        } else {
            $path = BASE_PATH . "/app/Backend/Controller/";
        }
