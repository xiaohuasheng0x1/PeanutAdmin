 ...
 * @property-read \Hyperf\Database\Model\Collection|Dept[] $depts
 * @property-read \Hyperf\Database\Model\Collection|Menu[] $menus
 * @property-read \Hyperf\Database\Model\Collection|User[] $users
 */
class Role extends PaModel
{
    use SoftDeletes;
    // 所有
