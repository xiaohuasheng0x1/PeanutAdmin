 ...
 * @property-read \Hyperf\Database\Model\Collection|User[] $receiveUser
 * @property-read User $sendUser
 */
class QueueMessage extends PaModel
{
    /**
     * 消息类型：通知
     * @var string
     ...
     * @var string
     */
    protected ?string $table = 'queue_message';
    /**
    ...
    {
        return $this->belongsToMany(User::class, 'queue_message_receive', 'message_id', 'user_id')->as('receive_users')->withPivot(...['read_status']);
    }
}