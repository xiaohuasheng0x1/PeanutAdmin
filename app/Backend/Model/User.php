 ...
 * @property-read Dept $dept
 * @property-read \Hyperf\Database\Model\Collection|Post[] $posts
 * @property-read \Hyperf\Database\Model\Collection|Role[] $roles
 * @property-write mixed $password 密码
 */
class User extends PaModel
{
    use SoftDeletes;
