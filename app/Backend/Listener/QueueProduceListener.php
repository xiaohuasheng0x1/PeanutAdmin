...
use App\Common\Amqp\Event\AfterProduce;
use App\Common\Amqp\Event\BeforeProduce;
use App\Common\Amqp\Event\FailToProduce;
use App\Common\Amqp\Event\ProduceEvent;
use App\Common\Amqp\Event\WaitTimeout;
...
class QueueProduceListener implements ListenerInterface
{
    ...
    private QueueLogService $service;
    ...
    {
        $this->service = container()->get(QueueLogService::class);
    ...
    public function afterProduce(object $event): void
    {
        ...
        if (isset($event->producer) && $event->producer instanceof MessageProducer) {
            container()->get(QueueMessageService::class)->save(
