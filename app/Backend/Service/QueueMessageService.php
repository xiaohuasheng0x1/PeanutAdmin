...
use App\Backend\Mapper\QueueMessageMapper;
 ...
 * 信息管理服务类
 */
class QueueMessageService extends AbstractService
{
    /**
     * @var QueueMessageMapper
     */
    public $mapper;

    public function __construct(QueueMessageMapper $mapper)
    {
        $this->mapper = $mapper;
    }
