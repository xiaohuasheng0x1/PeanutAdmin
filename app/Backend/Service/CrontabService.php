...
use App\Backend\Mapper\CrontabMapper;
...
class CrontabService extends AbstractService
{
    ...
    /**
     * @param CrontabMapper $mapper
     * @throws \Psr\Container\ContainerExceptionInterface
     * @throws \Psr\Container\NotFoundExceptionInterface
     */
    public function __construct(CrontabMapper $mapper)
    {
        $this->mapper = $mapper;
    ...
    *
    ...
    public function run($id): ?bool
    {
        ...
        $executor = $this->container->get(PaExecutor::class);
