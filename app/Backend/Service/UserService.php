...
class UserService extends AbstractService
{
     ...
     * @param MenuService $systemMenuService
     * @param RoleService $systemRoleService
     */
    public function __construct(
        ContainerInterface $container,
        UserMapper         $mapper,
        MenuService        $systemMenuService,
        RoleService        $systemRoleService
    )
    {
        $this->mapper = $mapper;
    ...
    public function getInfo(): array
    {
        ...
        throw new PaException(t('system.unable_get_userinfo'), 500);
    }
