...
class CreateQueueMessageReceiveTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('queue_message_receive', function (Blueprint $table) {
            $table->engine = 'Innodb';
    ...
    {
        Schema::dropIfExists('queue_message_receive');
    }
}
